    ...
    <div class="container">
        ...
        <?php else : ?>
            ...
            <div class="text-center py-5">
                ...
                <p>It seems we can't find what you're looking for in this archive.</p>
                <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="cta-button mt-3">Back to Home</a>
            </div>
...
<style>
    /* Reuse styling from index.php for consistency */
    .news-card {
        background: #fff;
        border-radius: 15px;
        overflow: hidden;
